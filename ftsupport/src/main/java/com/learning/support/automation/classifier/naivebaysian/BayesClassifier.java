package com.learning.support.automation.classifier.naivebaysian;
...
import com.learning.support.automation.classifier.Classification;
import com.learning.support.automation.classifier.Classifier;
    ...
    private SortedSet<Classification<T, K>> categoryProbabilities(
        ...
        SortedSet<Classification<T, K>> probabilities =
                new TreeSet<Classification<T, K>>(
					...
					public Comparator<Classification<T, K>> reversed() {
						// TODO Auto-generated method stub
						return null;
					}

					public Comparator<Classification<T, K>> thenComparing(
							Comparator<? super Classification<T, K>> arg0) {
						// TODO Auto-generated method stub
						return null;
					}
